...
export const RULE_CONDITION_NOT_RELEASE_COMMIT_PUSH =
...
export const RULE_IS_MAIN_BRANCH_AND_NOT_RELEASE_COMMIT_PUSH: GitlabRule = {
  if:
    RULE_CONDITION_MAIN_BRANCH +
    " && (" +
    RULE_CONDITION_NOT_RELEASE_COMMIT_PUSH +
    ")",
};
